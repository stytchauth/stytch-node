...
class SAML {
  ...
  updateConnection(data, options) {
    ...
    return (0, _shared.request)(this.fetchConfig, {
      method: "PUT",
      url: `/v1/b2b/sso/saml/${encodeURIComponent(data.organization_id)}/connections/${encodeURIComponent(data.connection_id)}`,
      headers,
      data: {
  ...
  updateByURL(data, options) {
    ...
    return (0, _shared.request)(this.fetchConfig, {
      method: "PUT",
      url: `/v1/b2b/sso/saml/${encodeURIComponent(data.organization_id)}/connections/${encodeURIComponent(data.connection_id)}/url`,
      headers,
      data: {
  ...
  deleteVerificationCertificate(data, options) {
    ...
    return (0, _shared.request)(this.fetchConfig, {
      method: "DELETE",
      url: `/v1/b2b/sso/saml/${encodeURIComponent(data.organization_id)}/connections/${encodeURIComponent(data.connection_id)}/verification_certificates/${encodeURIComponent(data.certificate_id)}`,
      headers,
      data: {}
    });
  }
  ...
  deleteEncryptionPrivateKey(data, options) {
    ...
    return (0, _shared.request)(this.fetchConfig, {
      method: "DELETE",
      url: `/v1/b2b/sso/saml/${encodeURIComponent(data.organization_id)}/connections/${encodeURIComponent(data.connection_id)}/encryption_private_keys/${encodeURIComponent(data.private_key_id)}`,
      headers,
      data: {}
    });
  }
