...
export class Email {
   ...
   */
  loginOrSignup(
    data: B2BEmailLoginOrSignupRequest
  ): Promise<B2BEmailLoginOrSignupResponse> {
    return request<B2BEmailLoginOrSignupResponse>(this.fetchConfig, {
      method: "POST",
  ...
  invite(data: B2BEmailInviteRequest): Promise<B2BEmailInviteResponse> {
    return request<B2BEmailInviteResponse>(this.fetchConfig, {
      method: "POST",
