...
export class OAuthProviders {
  ...
  */
  google(
    ...
    return request<B2BOrganizationsMembersOAuthProvidersGoogleResponse>(this.fetchConfig, {
      method: "GET",
  ...
  */
  microsoft(
    ...
    const headers: Record<string, string> = {};
    return request<B2BOrganizationsMembersOAuthProvidersMicrosoftResponse>(this.fetchConfig, {
      method: "GET",
  ...
  */
  slack(
    ...
    const headers: Record<string, string> = {};
    return request<B2BOrganizationsMembersOAuthProvidersSlackResponse>(this.fetchConfig, {
      method: "GET",
  ...
  */
  hubspot(
    ...
    const headers: Record<string, string> = {};
    return request<B2BOrganizationsMembersOAuthProvidersHubspotResponse>(this.fetchConfig, {
      method: "GET",
  ...
  */
  github(
    ...
    const headers: Record<string, string> = {};
    return request<B2BOrganizationsMembersOAuthProvidersGithubResponse>(this.fetchConfig, {
      method: "GET",
