...
export class Email {
   ...
   */
  loginOrSignup(
    data: B2BOTPEmailLoginOrSignupRequest
  ): Promise<B2BOTPEmailLoginOrSignupResponse> {
    const headers: Record<string, string> = {};
    return request<B2BOTPEmailLoginOrSignupResponse>(this.fetchConfig, {
      method: "POST",
   ...
   */
  authenticate(
    data: B2BOTPEmailAuthenticateRequest
  ): Promise<B2BOTPEmailAuthenticateResponse> {
    const headers: Record<string, string> = {};
    return request<B2BOTPEmailAuthenticateResponse>(this.fetchConfig, {
      method: "POST",
