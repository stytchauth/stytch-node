...
export class Clients {
  ...
  get(params: ClientsGetRequest): Promise<ClientsGetResponse> {
    return request<ClientsGetResponse>(this.fetchConfig, {
      method: "GET",
  ...
  search(data: ClientsSearchRequest): Promise<ClientsSearchResponse> {
    return request<ClientsSearchResponse>(this.fetchConfig, {
      method: "POST",
  ...
  update(data: ClientsUpdateRequest): Promise<ClientsUpdateResponse> {
    return request<ClientsUpdateResponse>(this.fetchConfig, {
      method: "PUT",
  ...
  delete(data: ClientsDeleteRequest): Promise<ClientsDeleteResponse> {
    return request<ClientsDeleteResponse>(this.fetchConfig, {
      method: "DELETE",
      url: `/v1/m2m/clients/${data.client_id}`,
      data: {},
    });
  ...
  create(data: ClientsCreateRequest): Promise<ClientsCreateResponse> {
    return request<ClientsCreateResponse>(this.fetchConfig, {
      method: "POST",
      url: `/v1/m2m/clients`,
      data,
    });
