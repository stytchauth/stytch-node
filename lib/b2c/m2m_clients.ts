...
export class Clients {
  ...
  */
  get(
    params: M2MClientsGetRequest,
  ): Promise<M2MClientsGetResponse> {
  ...
  */
  search(
    data: M2MClientsSearchRequest,
  ): Promise<M2MClientsSearchResponse> {
    const headers: Record<string, string> = {};
  ...
  */
  update(
    data: M2MClientsUpdateRequest,
  ): Promise<M2MClientsUpdateResponse> {
    const headers: Record<string, string> = {};
  ...
  */
  delete(
    data: M2MClientsDeleteRequest,
  ): Promise<M2MClientsDeleteResponse> {
    const headers: Record<string, string> = {};
  ...
  */
  create(
    data: M2MClientsCreateRequest,
  ): Promise<M2MClientsCreateResponse> {
    const headers: Record<string, string> = {};
