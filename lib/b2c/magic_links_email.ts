...
export class Email {
  ...
  send(data: EmailSendRequest): Promise<EmailSendResponse> {
    return request<EmailSendResponse>(this.fetchConfig, {
      method: "POST",
   ...
   */
  loginOrCreate(
    data: EmailLoginOrCreateRequest
  ): Promise<EmailLoginOrCreateResponse> {
    return request<EmailLoginOrCreateResponse>(this.fetchConfig, {
      method: "POST",
  ...
  invite(data: EmailInviteRequest): Promise<EmailInviteResponse> {
    return request<EmailInviteResponse>(this.fetchConfig, {
      method: "POST",
  ...
  revokeInvite(
    data: EmailRevokeInviteRequest
  ): Promise<EmailRevokeInviteResponse> {
    return request<EmailRevokeInviteResponse>(this.fetchConfig, {
      method: "POST",
