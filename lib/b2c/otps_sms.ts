...
export class Sms {
  ...
  send(data: SmsSendRequest): Promise<SmsSendResponse> {
    return request<SmsSendResponse>(this.fetchConfig, {
      method: "POST",
   ...
   */
  loginOrCreate(
    data: SmsLoginOrCreateRequest
  ): Promise<SmsLoginOrCreateResponse> {
    return request<SmsLoginOrCreateResponse>(this.fetchConfig, {
      method: "POST",
