...
export class Whatsapp {
  ...
  send(data: WhatsappSendRequest): Promise<WhatsappSendResponse> {
    return request<WhatsappSendResponse>(this.fetchConfig, {
      method: "POST",
   ...
   */
  loginOrCreate(
    data: WhatsappLoginOrCreateRequest
  ): Promise<WhatsappLoginOrCreateResponse> {
    return request<WhatsappLoginOrCreateResponse>(this.fetchConfig, {
      method: "POST",
