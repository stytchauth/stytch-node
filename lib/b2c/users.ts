...
export class Users {
  ...
  */
  deleteTOTP(
    data: UsersDeleteTOTPRequest,
  ): Promise<UsersDeleteTOTPResponse> {
    const headers: Record<string, string> = {};
  ...
  */
  revoke(
    data: UsersRevokeRequest,
  ): Promise<UsersRevokeResponse> {
    const headers: Record<string, string> = {};
