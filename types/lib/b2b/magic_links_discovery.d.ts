...
export interface B2BDiscoveryAuthenticateRequest {
    discovery_magic_links_token: string;
    pkce_code_verifier?: string;
}
export interface B2BDiscoveryAuthenticateResponse {
    /**
...
export declare class Discovery {
     ...
     */
    authenticate(data: B2BDiscoveryAuthenticateRequest): Promise<B2BDiscoveryAuthenticateResponse>;
}
