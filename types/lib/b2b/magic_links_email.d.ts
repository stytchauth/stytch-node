...
export interface B2BEmailInviteRequest {
    /**
...
export interface B2BEmailInviteResponse {
    /**
...
export interface B2BEmailLoginOrSignupRequest {
    /**
     * Globally unique UUID that identifies a specific Organization. The `organization_id` is critical to
     * perform operations on an Organization, so be sure to preserve this value.
     */
...
export interface B2BEmailLoginOrSignupResponse {
    /**
     * Globally unique UUID that is returned with every API call. This value is important to log for debugging
     * purposes; we may ask for this value to help identify a specific API call when helping you debug an issue.
     */
...
export declare class Email {
     ...
     */
    loginOrSignup(data: B2BEmailLoginOrSignupRequest): Promise<B2BEmailLoginOrSignupResponse>;
    /**
     ...
     */
    invite(data: B2BEmailInviteRequest): Promise<B2BEmailInviteResponse>;
}
