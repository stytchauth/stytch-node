...
export interface B2BExistingPasswordResetRequest {
...
export interface B2BExistingPasswordResetResponse {
    /**
...
export declare class ExistingPassword {
     ...
     */
    reset(data: B2BExistingPasswordResetRequest): Promise<B2BExistingPasswordResetResponse>;
}
