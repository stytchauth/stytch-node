...
export declare class OIDC {
    ...
    createConnection(data: B2BOIDCCreateConnectionRequest): Promise<B2BOIDCCreateConnectionResponse>;
    /**
     ...
     * * `jwks_url`
     */
    updateConnection(data: B2BOIDCUpdateConnectionRequest): Promise<B2BOIDCUpdateConnectionResponse>;
}
