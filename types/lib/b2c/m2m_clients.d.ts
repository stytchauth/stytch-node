...
export interface ClientsCreateResponse {
    /**
...
export interface ClientsUpdateResponse {
    /**
     * Globally unique UUID that is returned with every API call. This value is important to log for debugging
     * purposes; we may ask for this value to help identify a specific API call when helping you debug an issue.
     */
...
export declare class Clients {
    ...
    get(params: ClientsGetRequest): Promise<ClientsGetResponse>;
    /**
     ...
     */
    search(data: ClientsSearchRequest): Promise<ClientsSearchResponse>;
    /**
     ...
     */
    update(data: ClientsUpdateRequest): Promise<ClientsUpdateResponse>;
    /**
     ...
     * when[authenticating the token](https://stytch.com/docs/b2b/api/authenticate-m2m-token)[authenticating the token](https://stytch.com/docs/api/authenticate-m2m-token).
     */
    delete(data: ClientsDeleteRequest): Promise<ClientsDeleteResponse>;
    /**
     ...
     */
    create(data: ClientsCreateRequest): Promise<ClientsCreateResponse>;
}
