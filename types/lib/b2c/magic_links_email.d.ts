...
export interface EmailLoginOrCreateRequest {
    email: string;
    /**
...
export interface EmailRevokeInviteRequest {
    email: string;
}
export interface EmailRevokeInviteResponse {
    /**
     * Globally unique UUID that is returned with every API call. This value is important to log for debugging
     * purposes; we may ask for this value to help identify a specific API call when helping you debug an issue.
     */
...
export declare class Email {
     ...
     * authentication.
     */
    send(data: EmailSendRequest): Promise<EmailSendResponse>;
    /**
     ...
     * authentication.
     */
    loginOrCreate(data: EmailLoginOrCreateRequest): Promise<EmailLoginOrCreateResponse>;
    /**
     ...
     * authentication.
     */
    invite(data: EmailInviteRequest): Promise<EmailInviteResponse>;
    revokeInvite(data: EmailRevokeInviteRequest): Promise<EmailRevokeInviteResponse>;
}
