...
export interface WhatsappLoginOrCreateRequest {
    /**
...
export interface WhatsappLoginOrCreateResponse {
    /**
...
export declare class Whatsapp {
     ...
     */
    send(data: WhatsappSendRequest): Promise<WhatsappSendResponse>;
    /**
     ...
     * `phone_id` found in the response as the `method_id`.
     */
    loginOrCreate(data: WhatsappLoginOrCreateRequest): Promise<WhatsappLoginOrCreateResponse>;
}
